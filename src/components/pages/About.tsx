    ...
    <div className='container'>
      <div className='py-4'>
        ...
        <p className='lead py-4'>
          ...
          token item ? If yes, the route will continue on the destination page.
          Otherwise, react will call the Redirect component to redirect to the
          login page.
          <br />
          <br />
          ...
          <br />
          <br />
          Application includes searcher. User may filter data JSON in table by
          key words.
          <br />
          <br />
