    ...
    <div className='container'>
      <div className='py-4'>
        ...
        <p className='lead py-4'>
          ...
          aplication. Aplication includes protection for a page. The rendering
          ...
          <br />
          <br />
          The user gets the impression that the operation is being performed by
          animating the appearance of sorted data.
          <br />
          <br />
